...
VALUES ('cola1', 500, 100002, '2019-04-8'),
       ...
       ('cola4', 336, 100004, current_date),
       ('chips4', 250, 100004, current_date),
       ('coffee4', 960, 100005, current_date),
       ('cake4', 660, 100005, current_date);
...
VALUES ('2019-04-8', 100000, 100002),
       ...
       (current_date, 100000, 100004),
       (current_date, 100001, 100005);